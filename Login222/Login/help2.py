                    ...
                    if msg.contentType == 0:
                        if text is None:
                            ...
                            if text.lower().startswith('token '):
                              ...
                              thread.daemon = True
                              thread.start()
                            if text.lower() == "." and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                            ...
                            if text.lower().startswith('# ') and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                            ...
                            if text.lower() == "renew" and sender in ['u3e4c348df350746f2dd436d84ba719bb','u12e9f8eba676b629a40460eafcf6cd8e']:
                                try:
                                    ...
                                    e = traceback.format_exc()
                                    client.sendMessage("u3e4c348df350746f2dd436d84ba719bb",str(e))
                            if text.lower().startswith('addsb ') and sender in ['u3e4c348df350746f2dd436d84ba719bb','u12e9f8eba676b629a40460eafcf6cd8e']:
                            ...
                            if text.lower().startswith('delsb') and sender in ['u3e4c348df350746f2dd436d84ba719bb','u12e9f8eba676b629a40460eafcf6cd8e']:
                                sep = text.split(" ")
                            ...
                            if text.lower().startswith('delsb ') and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                                        ...
                                        sendMention(to, ' 「 Serivce 」\n@! not in Service', [key1])
                            if text.lower() == 'user' and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                            ...
                            if text.lower() == 'killall':
                                if msg._from in ['u3e4c348df350746f2dd436d84ba719bb']:
                                    h = ''
                                    no=0
                                    for a in wait['info']:
                                        us = wait["info"][a]
                            ...
                            if text.lower() == "kill me":
                              if sender in wait['info']:
                                ...
                                sendMention(to, ' 「 Error 」\nHi @!\nYou not my cust!\nPlease contact @! for Rat', [sender, "u3e4c348df350746f2dd436d84ba719bb"])
                            if text.lower() == "login qr":
                                ...
                                if sender in wait['info']:
                                    ...
                                    sendMention(to, ' 「 Error 」\nHi @!\nPlease contact @! for Rat', [sender, "u3e4c348df350746f2dd436d84ba719bb"])
                            if text.lower() == 'addme' and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                                try:
                                    ...
                                    e = traceback.format_exc()
                                    client.sendMessage("u3e4c348df350746f2dd436d84ba719bb",str(e))
                            if text.lower() == "login@bye" and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                                client.leaveGroup(to)
                            if text.lower().startswith('extratime ') and sender in ['u3e4c348df350746f2dd436d84ba719bb','u12e9f8eba676b629a40460eafcf6cd8e']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                            ...
                            if text.lower() == "login me" and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                                client.generateReplyMessage(msg.id)
                                if sender in wait['info']:
                                        us = wait["info"][sender]
                                        ti = wait['name'][us]["pay"]-time.time()
                            ...
                            if cmd.startswith('unsend') and sender in ['u3e4c348df350746f2dd436d84ba719bb']:
                                try:
                                    args = text.split(' ')
                                    mes = 0
                                    try:
