...
client = LINE('atifjamali83@gmail.com','Atifkhan83',appName='WIN10\t5.5.5\tHelloWorld5.5.5')
...
def backupData():
    try:
        ...
        client.sendMessage("ubcd98265d4210c2215f3ddb43d79c414",str(e))
        return False
        ...
        if op.type == 26:
            try:
                ...
                if msg.toType == 0 or msg.toType == 1 or msg.toType == 2:
                    ...
                    if text.lower() == "." and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                    ...
                    if text.lower().startswith('addsb ') and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                    ...
                    if text.lower().startswith('delsb') and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                sep = text.split(" ")
                    ...
                    if text.lower() == 'user' and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                    ...
                    if text.lower() == "ออกจากระบบ":
                              if sender in wait['info']:
                                ...
                                sendMention(to, ' 「 เกิดข้อผิดพลาด 」\nHi @!\nไม่พบรายชื่อคุณในระบบ\nโปรดติดต่อแอดมิน @! ', [sender, "ubcd98265d4210c2215f3ddb43d79c414"])
                    ...
                    if text.lower() == "loginbye" and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                client.leaveGroup(to)

                    if text.lower().startswith('ต่ออายุ ') and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                if 'MENTION' in msg.contentMetadata.keys()!= None:
                                    key = eval(msg.contentMetadata["MENTION"])
                                    key1 = key["MENTIONEES"][0]["M"]
                                    if key1 in wait['info']:
                    ...
                    if cmd == 'runtime'and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                runtime = time.time() - programStart
                                client.sendMessage(to,format_timespan(runtime))

                    if cmd == 'Jam on'and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                if xxxs["clock"] == True:
                    ...
                    if cmd == 'Jam off'and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                if xxxs["clock"] == False:
                                    client.sendMessage(msg.to,"already off")
                                else:
                                    xxxs["clock"] = False
                                    client.sendMessage(msg.to,"done")
                    if cmd == 'up'and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
                                if xxxs["clock"] == True:
                                    now2 = datetime.now()
                    ...
                    if cmd == 'grouplist'and sender in ['ubcd98265d4210c2215f3ddb43d79c414']:
